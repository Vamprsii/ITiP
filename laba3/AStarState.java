...
public class AStarState
{
    ...
    public boolean addOpenWaypoint(Waypoint newWP)
    {
        ...
        if (!openedWaypoints.containsKey(loc) || newWP.getPreviousCost() < openedWaypoints.get(loc).getPreviousCost()) {
    ...
    {
        Waypoint toClose = openedWaypoints.remove(loc);
        if (toClose != null) {
            closedWaypoints.put(loc, toClose);
        }
    }
